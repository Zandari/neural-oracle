...
База данных для хранения пользователей и их ключей доступа реализована с использованием SQLite и в частности библиотеки aiosqlite для организации асинхронного доступа к БД. Выбор был обусловлен контекстом выполнения проекта (тестовое задание) и простотой использования. Доступ к БД осуществляется посредством SQL запросов, без использования ORM с целью минимизирования зависимостей.
